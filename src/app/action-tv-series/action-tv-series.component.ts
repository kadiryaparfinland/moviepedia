...
@Component({
  selector: 'app-action-tv-series',
  templateUrl: './action-tv-series.component.html',
  styleUrls: ['./action-tv-series.component.css']
})
export class ActionTvSeriesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getActionTvSeries().subscribe((movies) => {
