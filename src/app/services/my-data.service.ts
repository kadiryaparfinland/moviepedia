...
export class MyDataService {
  ...
  getScienceFictionMovies() {
    return this.http.get('https://api.themoviedb.org/3/discover/movie?api_key=dc92a7524c83f242a3237b2222941f00&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_genres=878');
  }
  ...
  getOnlineWatchListTv(movieId: string) : Observable<any> {
    return this.http.get('https://api.themoviedb.org/3/tv/'+movieId+'/watch/providers?api_key=dc92a7524c83f242a3237b2222941f00');
   }
