...
@Component({
  selector: 'app-family-tv-series',
  templateUrl: './family-tv-series.component.html',
  styleUrls: ['./family-tv-series.component.css']
})
export class FamilyTvSeriesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getFamilyTvSeries().subscribe((movies) => {
