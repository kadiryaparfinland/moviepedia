...
@Component({
  selector: 'app-tv-series-images',
  templateUrl: './tv-series-images.component.html',
  styleUrls: ['./tv-series-images.component.css']
})
export class TvSeriesImagesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.myDataService.getTvSeriesImages(this.movieId).subscribe((images) => {
