...
@Component({
  selector: 'app-crime-tv-series',
  templateUrl: './crime-tv-series.component.html',
  styleUrls: ['./crime-tv-series.component.css']
})
export class CrimeTvSeriesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getCrimeTvSeries().subscribe((movies) => {
