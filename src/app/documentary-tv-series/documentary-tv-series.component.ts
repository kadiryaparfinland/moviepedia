...
@Component({
  selector: 'app-documentary-tv-series',
  templateUrl: './documentary-tv-series.component.html',
  styleUrls: ['./documentary-tv-series.component.css']
})
export class DocumentaryTvSeriesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getDocumentaryTvSeries().subscribe((movies) => {
