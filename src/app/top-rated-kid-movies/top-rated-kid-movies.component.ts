...
@Component({
  selector: 'app-top-rated-kid-movies',
  templateUrl: './top-rated-kid-movies.component.html',
  styleUrls: ['./top-rated-kid-movies.component.css']
})
export class TopRatedKidMoviesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getTopRatedKidMovies().subscribe((movies) => {
