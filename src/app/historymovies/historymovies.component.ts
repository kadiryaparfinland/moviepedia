...
@Component({
  selector: 'app-historymovies',
  templateUrl: './historymovies.component.html',
  styleUrls: ['./historymovies.component.css']
})
export class HistorymoviesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getHistoryMovies().subscribe((movies) => {
