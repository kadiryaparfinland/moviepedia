...
@Component({
  selector: 'app-war-tv-series',
  templateUrl: './war-tv-series.component.html',
  styleUrls: ['./war-tv-series.component.css']
})
export class WarTvSeriesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getWarTvSeries().subscribe((movies) => {
