...
@Component({
  selector: 'app-drama-tv-series',
  templateUrl: './drama-tv-series.component.html',
  styleUrls: ['./drama-tv-series.component.css']
})
export class DramaTvSeriesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getDramaTvSeries().subscribe((movies) => {
