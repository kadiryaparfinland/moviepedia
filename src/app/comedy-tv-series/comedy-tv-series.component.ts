...
@Component({
  selector: 'app-comedy-tv-series',
  templateUrl: './comedy-tv-series.component.html',
  styleUrls: ['./comedy-tv-series.component.css']
})
export class ComedyTvSeriesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getComedyTvSeries().subscribe((movies) => {
