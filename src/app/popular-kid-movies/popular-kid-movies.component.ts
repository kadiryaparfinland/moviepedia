...
@Component({
  selector: 'app-popular-kid-movies',
  templateUrl: './popular-kid-movies.component.html',
  styleUrls: ['./popular-kid-movies.component.css']
})
export class PopularKidMoviesComponent implements OnInit  {
  movieId: number = 0;
  myMovies: any;
  topRatedMovies: any = [];
