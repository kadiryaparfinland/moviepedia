...
@Component({
  selector: 'app-sci-fic-tv-series',
  templateUrl: './sci-fic-tv-series.component.html',
  styleUrls: ['./sci-fic-tv-series.component.css']
})
export class SciFicTvSeriesComponent implements OnInit {
  ...
  ngOnInit() {
    this.myDataService.getSciFicTvSeries().subscribe((movies) => {
